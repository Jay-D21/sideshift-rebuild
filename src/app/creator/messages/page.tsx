...
export default function CreatorMessagesPage() {
  return (
    <div className="h-[calc(100vh-3rem)] flex flex-col p-6 max-h-screen">
      <div className="mb-6 flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-bold text-[#202020]">Messages</h1>
          <p className="text-sm text-gray-500 mt-1">Communicate with brands about your campaigns.</p>
        </div>
      ...
      <div className="flex-1 bg-white rounded-xl border border-gray-200 shadow-sm overflow-hidden flex min-h-[500px]">
        {/* Sidebar */}
        <div className="w-80 border-r border-gray-100 flex flex-col bg-gray-50 shrink-0 hidden md:flex">
        ...
        <div className="flex-1 flex flex-col items-center justify-center bg-white text-center p-8">
          ...
          <p className="text-gray-500 text-sm max-w-sm mt-2">
            Select a conversation from the sidebar or start a new one to chat with brands.
          </p>
        </div>
      </div>
    </div>
